...
;
    ...
    public function sauvJSON() {
        $json_liste_new = realpath(dirname(__FILE__) . 'plugins/JeeOrangeTv/core/config/chaines.json');
        $json_liste_sauv = realpath('plugins/JeeOrangeTv/core/config/chaines.json_old');
