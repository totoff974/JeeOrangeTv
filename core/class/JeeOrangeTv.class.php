        ...
        if ($this->getName() == "Telecommande") {
            ...
            if ($action_mosaique == 0) {
                ...
                $code_touche = $this->getConfiguration('code_touche');
                    if ($code_touche != "") {
                        log::add('JeeOrangeTv', 'default', 'Action executée JeeOrangeTv IP : ' . $box_ip . ' - touche : ' . $this->getName() . ' - code touche : ' . $code_touche . ' - mode : ' . $code_mode);
            ...
            if ($action_mosaique == 1) {
                ...
                log::add('JeeOrangeTv', 'default', 'Mosaique Chaine : ' . $mos_chaine . ' - Numéro de la chaine : '. $mos_num . ' - Id de la chaine : '. $mos_id);
